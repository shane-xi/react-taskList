...
/***/ function(module, exports, __webpack_require__) {
	...
	var AppWrap = __webpack_require__(160); //加载组件
	...
	var App = React.createClass({displayName: "App",
		render: function () {
			return (
				React.createElement(AppWrap, null)
			)
		}
	})
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoList = React.createClass({displayName: "TodoList",
		render: function () {
			return (
				...
				React.createElement("h1", {className: "todo-title"}, "React todoList"), 
			React.createElement(TaskList, {todo: this.state.todoList, taskDel: this.handlerchange, taskComplete: this.handlerchange}), 
			React.createElement("div", {className: "hr"}), 
				React.createElement(TaskCount, {todo: this.state.todoList}), 
			React.createElement(NewTask, {todo: this.state.todoList, newList: this.handlerchange})
			)
			)
		},
		getInitialState: function () {
	...
	var TaskList = React.createClass({displayName: "TaskList",
		render: function () {
			var listNode = this.props.todo.map(function(item,i){
					return (
				React.createElement(TaskItem, {item: item, i: i, key: i, handlerDel: this.handlerDel})
			)
		}.bind(this));
			return (
				React.createElement("ul", {onClick: this.handlerComplete}, 
			listNode
			)
			)
		},
	...
	var TaskItem = React.createClass({displayName: "TaskItem",
		render: function () {
			...
			if (this.props.item.complete == true) {
				content = React.createElement("s", null, this.props.item.content);
			}
			return (
				React.createElement("li", {key: this.props.i, className: "task-list "+this.props.item.complete, "data-key": this.props.i, onMouseOver: this.btnShow, onMouseOut: this.btnHide}, 
			React.createElement("lable", {className: "task-content"}, content), 
				React.createElement("button", {onClick: this.handlerDel, className: "task-del", ref: "delBtn", "data-key": this.propsi}, "删除")
			)
			)
		},
	...
	//任务进度
	var TaskCount = React.createClass({displayName: "TaskCount",
		render: function () {
			var count = this.props.todo.length;
			var completeCount = this.props.todo.filter(function(item){
					if (item.complete) {
				return item;
			}
		}).length;
			return (
				React.createElement("p", {className: "task-count"}, 
				React.createElement("span", null, "已完成", completeCount), "/", 
			React.createElement("span", null, "总数", count)
			)
			)
		}
	})
		...
		render: function () {
			return (
				React.createElement("form", {action: ""}, 
					React.createElement("input", {className: "add-content", type: "text", placeholder: "添加新任务", ref: "inputNew"}), 
					React.createElement("button", {className: "task-add btn", onClick: this.handlerAdd}, "保存"), 
					React.createElement("button", {className: "task-cancel btn", onClick: this.handlerDel}, "取消")
				)
			)
		},
